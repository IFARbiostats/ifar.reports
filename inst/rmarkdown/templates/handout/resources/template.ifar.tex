...
\makeatother
 ...
 \usepackage{fancyhdr}
  ...
  \renewcommand{\footrulewidth}{0.5pt}
   ...
   \cfoot{\footnotesize IFAR Biostatistics \hspace{.025 in} \cdot \hspace{.05 in} 1200 Centre St. Boston, MA, USA 02131 \hspace{.025 in} \cdot \hspace{.05 in} 617.971.5386 \hspace{.025 in} \cdot \hspace{.05 in} stats@hsl.harvard.edu  }
