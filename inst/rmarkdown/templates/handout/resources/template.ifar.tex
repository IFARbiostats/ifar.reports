...
$endif$
$endif$
$if(listings)$ % modifed tgt 13 jan 2017
...
\usepackage[osf]{libertine} %load Linux Libertine so no need for installation
...
\usepackage{booktabs, dcolumn, float, titlesec, microtype, multirow} % formatted tables, decimal alignment, dealing with floats, title and section formatting
